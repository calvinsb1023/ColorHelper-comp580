...
public class ColorUtils {
	...
	private void initColorList() {
		...
		colorList.add(new ColorName("Tan", "#d6a090"));
		colorList.add(new ColorName("Orange Red", "#fe3b1e"));
		colorList.add(new ColorName("Rouge", "#a12c32"));
		colorList.add(new ColorName("Strong Pink", "#fa2f7a"));
		colorList.add(new ColorName("Bubblegum Pink", "#fb9fda"));
		colorList.add(new ColorName("Dark Pink", "#e61cf7"));
		colorList.add(new ColorName("Purple", "#992f7c"));
		colorList.add(new ColorName("Burgundy", "#47011f"));
		colorList.add(new ColorName("Midnight Blue", "#051155"));
		colorList.add(new ColorName("Dark Blue", "#4f02ec"));
		colorList.add(new ColorName("Azure", "#00a6ee"));
		colorList.add(new ColorName("Robin's Egg", "#6febff"));
		colorList.add(new ColorName("Sea Green", "#08a29a"));
		colorList.add(new ColorName("Dark Aqua", "#2a666a"));
		colorList.add(new ColorName("Forest Green", "#063619"));
		colorList.add(new ColorName("Black", "#000000"));
		colorList.add(new ColorName("Dark Grey", "#4a4957"));
		colorList.add(new ColorName("Purple Grey", "#8e7ba4"));
		colorList.add(new ColorName("Periwinkle", "#b7c0ff"));
		colorList.add(new ColorName("White", "#ffffff"));
		colorList.add(new ColorName("Sea Grey", "#acbe9c"));
		colorList.add(new ColorName("Medium Grey", "#827c70"));
		colorList.add(new ColorName("Brown", "#5a3b1c"));
		colorList.add(new ColorName("Umber", "#ae6507"));
		colorList.add(new ColorName("Yellow Orange", "#f7aa30"));
		colorList.add(new ColorName("Yellow", "#f4ea5c"));
		colorList.add(new ColorName("Olive", "#9b9500"));
		colorList.add(new ColorName("Dark Olive", "#566204"));
		colorList.add(new ColorName("Dark Green", "#11963b"));
		colorList.add(new ColorName("Lawn Green", "#51e113"));
		colorList.add(new ColorName("Bright Teal", "#08fdcc"));
		colorList.add(new ColorName("Dark Khaki", 0xBD, 0xB7, 0x6B));
		colorList.add(new ColorName("Khaki", 0xF0, 0xE6, 0x8C));
		colorList.add(new ColorName("Carolina Blue", 0x7B, 0xAF, 0xD4));
		colorList.add(new ColorName("Saddle Brown", 0x8B, 0x45, 0x13));
	...
	*/
	...
	public class ColorName {
		...
		public ColorName(String name, String colorStr) {
		...
		public int computeMSE(int pixR, int pixG, int pixB) {
			return Math.round((float) ((pixR - r) * (pixR - r) + (pixG - g) * (pixG - g) + (pixB - b)
					* (pixB - b)) / 3);
		}
